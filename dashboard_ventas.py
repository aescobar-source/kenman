...
# ─────────────────────────────────────────────
st.set_page_config(page_title="Dashboard Ejecutivo de Ventas 2026", page_icon="📊", layout="wide", initial_sidebar_state="expanded")

COLORS = {
    "bg": "#F8F8F8", "card": "#FFFFFF", "border": "#E0E0E0", "text_dark": "#1A1A1A",
    "text_mid": "#555555", "text_light": "#888888", "accent": "#2C2C2C",
    "gray1": "#E8E8E8", "gray2": "#C0C0C0", "gray3": "#8A8A8A", "gray4": "#4A4A4A",
    "gray5": "#1A1A1A", "pos": "#3A3A3A", "neg": "#A0A0A0", "highlight": "#222222",
}
...
with col1:
    # Calculamos la desviación para que Streamlit pinte verde (+) o rojo (-) automáticamente
...
# 👇 👇 👇
# [AQUÍ CONTINÚA TU CÓDIGO ORIGINAL CON TABS Y LAS OTRAS GRÁFICAS]
