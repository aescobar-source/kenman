...
def load_data(file_bytes):
    ...
    if sheet_metas:
        ...
        # Búsqueda flexible de la columna Ejecutivo (Ejecutivo, Ejecutvo, etc)
        ...
        # Búsqueda flexible de la columna Meta
    ...
    # Homologar nombre Ejecutivo en BD principal por si a futuro lo corrigen en el Excel
