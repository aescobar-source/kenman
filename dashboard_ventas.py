...
<style>
  ...
  .page-subtitle {{ font-size: 0.85rem; color: {COLORS['text_light']}; margin-top: 2px; }}
    ...
    /* 1. Forzar color oscuro en el botón y textos del File Uploader */
    ...
    [data-testid="stFileUploader"] small {{
        color: #555555 !important; /* Muestra el texto '200MB per file • XLSX, XLS' */
    }}

    [data-testid="stFileUploader"] label {{
        color: #1A1A1A !important; /* Muestra el título '📂 Subir BD de Ventas' */
    }}

    /* 2. Forzar visibilidad en los mensajes de alerta/advertencia de Streamlit */
    [data-testid="stNotification"] {{
        color: #1A1A1A !important;
        background-color: #FFF3CD !important; /* Fondo amarillento suave clásico de advertencia */
